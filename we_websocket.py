...
import websocket
import json
from play import play_video_with_sound
from recieve_guide import extract_content
from request_save import play_sequentially_with_preloading
...
from voice_in import async_play_wav_windows, play_wav_windows, request_and_save_wav
    ...
    try:
        ...
        # 检查 'Type' 是否为 3（进入直播间）
            ...
            if welcome_counter < 2 or (last_welcome_time and (current_time - last_welcome_time).total_seconds() > 60):
                welcome_content = "，欢迎进入神秘的塔罗世界！我是神女祭司..."
